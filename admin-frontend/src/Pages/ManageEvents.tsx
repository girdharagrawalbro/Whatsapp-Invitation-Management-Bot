...
import { fetchEvents, addEvent, editEvent, deleteEvent, makePdf } from '@/services/apiService';
...
export default function ManageEvents() {
  ...
  const { data: events = [], isLoading: loading, error, refetch } = useQuery<Event[]>({
    queryKey: ['events'],
    queryFn: fetchEvents
  });

  const queryError = error ? 'Failed to load events' : null;
  ...
  const handleEditEvent = async (e: React.FormEvent) => {
    ...
    editEventMutation.mutate({ id: currentEvent._id, data: formData })
  }
